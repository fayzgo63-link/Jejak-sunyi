...
print(f"{Fore.LIGHTCYAN_EX}EXAMPLE HTTP METHODS-> CONNECT GET PUT POST")
print(f"{Fore.LIGHTCYAN_EX}HTTP METHODS-> SERVER CLOUDFLARE PYFLOODER GATEWAY")
methods_loader = input(F"{Fore.LIGHTCYAN_EX}HTTP_METHODS (EXAMPLE=GATEWAY)>").upper()
spam_create_thread = int(input(F"{Fore.LIGHTCYAan_EX}SPAM CREATE: {Fore.LIGHTGREEN_EX}"))
